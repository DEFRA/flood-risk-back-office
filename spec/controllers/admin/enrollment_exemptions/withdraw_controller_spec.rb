...
module Admin
  module EnrollmentExemptions
    RSpec.describe WithdrawController, type: :controller do
      ...
      describe "create action" do
        context "with success" do
          before do
            allow_any_instance_of(WithdrawForm).to receive(:validate).and_return(true)
            allow_any_instance_of(WithdrawForm).to receive(:save).and_return(true)
          end
        ...
        context "with failure" do
          before do
            allow_any_instance_of(WithdrawForm).to receive(:validate).and_return(false)
          end
