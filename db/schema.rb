...
ActiveRecord::Schema.define(version: 20160418094459) do
  ...
  add_index "user_versions", %w(item_type item_id), name: "index_user_versions_on_item_type_and_item_id", using: :btree
